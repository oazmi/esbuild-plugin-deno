...
import { InvertibleMap, type esbuild, object_entries, parseFilepathInfo } from "../deps.ts"
import extensionMap from "./extensions.json" with { type: "json" }
import mimeMap from "./mimes.json" with { type: "json" }
