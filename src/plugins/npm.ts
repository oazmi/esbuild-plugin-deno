...
import { DEBUG, defaultResolvePath, ensureEndSlash, type esbuild, escapeLiteralStringForRegex, isString, parsePackageUrl, pathToPosixPath, replacePrefix } from "../deps.ts"
