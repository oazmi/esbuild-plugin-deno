/** Options for {@linkcode JsonStringifyStream}. */ export interface StringifyStreamOptions {
  /**
 ...
 * });
 * ```
 */ export declare class JsonStringifyStream extends TransformStream<unknown, string> {
  /**
...
//# sourceMappingURL=stringify_stream.d.ts.map