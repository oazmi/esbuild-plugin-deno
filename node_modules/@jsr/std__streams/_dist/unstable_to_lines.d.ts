 ...
 * ]);
 * ```
 */ export declare function toLines(readable: ReadableStream<Uint8Array>, options?: StreamPipeOptions): ReadableStream<string>;
//# sourceMappingURL=unstable_to_lines.d.ts.map