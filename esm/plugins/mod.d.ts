...
*/
export declare const denoPlugins: (config?: Partial<DenoPluginsConfig>) => [importmap_plugin: esbuild.Plugin, http_plugin: esbuild.Plugin, jsr_plugin: esbuild.Plugin];
