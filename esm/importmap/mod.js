 ...
 * ```
*/
export const resolvePathFromImportMap = (path_alias, import_map) => {
 ...
 * ```
*/
export const resolvePathFromImportMapEntries = (path_alias, import_map_entries, config) => {
    ...
    const unprefixed_path_alias = replacePrefix(normalizePath(path_alias), baseAliasDir), relative_path_alias = (unprefixed_path_alias === ""
